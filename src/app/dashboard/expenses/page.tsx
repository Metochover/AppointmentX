...
export default function ExpensesPage() {
    ...
    const handleAddExpense = (e: React.FormEvent) => {
        ...
        setFormData({ startDate: '', endDate: '', category: categories[0], employee: employees[0], description: '', amount: 0, commissionRate: 0 });
        setIsModalOpen(false);
    };

    return (
        <div className="max-w-7xl mx-auto py-10 px-2">
            <h1 className="text-3xl font-bold mb-8 text-black">Masraf Takibi</h1>
            <button
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-xl relative animate-fade-in">
                        ...
                        <form onSubmit={handleAddExpense} className="space-y-5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-black mb-2 flex justify-between items-center">
                                        Komisyon Oranı
